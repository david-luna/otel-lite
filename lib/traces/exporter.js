...
const TraceServiceRequest = root.lookupType('opentelemetry.proto.collector.trace.v1.ExportTraceServiceRequest');
...
function handleBatch(record) {
  ...
  console.log('export encoded')
  console.log(TraceServiceRequest.encode(reqPayload));
